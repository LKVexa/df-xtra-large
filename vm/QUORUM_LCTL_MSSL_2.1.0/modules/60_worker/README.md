# 60. Worker — QUORUM LCTL/MSSL Reimagination
...
Six independent JA Operations Language scripts define the shared approved repository-job/report contract and specialized build, test, translation, rendering, and packaging workers.
