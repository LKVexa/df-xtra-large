# 55. Capability Manifests and Permissions — QUORUM LCTL/MSSL Reimagination
...
Four independent JA Security Policy Language scripts define capabilities, command permissions, action scope, and policy-bound execution rights.
