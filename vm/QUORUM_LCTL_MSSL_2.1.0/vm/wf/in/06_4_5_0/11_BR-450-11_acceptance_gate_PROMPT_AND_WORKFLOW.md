# QUORUM BR-450-11 — Acceptance gate
...
### Atomic requirements
- **BR-450-11-R01:** Every injected interruption recovers predictably
- **BR-450-11-R02:** No partially installed image becomes active
- **BR-450-11-R03:** Latest authenticated committed state wins
- **BR-450-11-R04:** Previous valid image remains recoverable
...
### Q2 — Implementation
1. **BR-450-11-R01 — Every injected interruption recovers predictably.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
2. **BR-450-11-R02 — No partially installed image becomes active.** Implement and verify this requirement with explicit invariants, negative tests, deterministic replay, resource bounds, and evidence artifacts.
3. **BR-450-11-R03 — Latest authenticated committed state wins.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
4. **BR-450-11-R04 — Previous valid image remains recoverable.** Implement and verify this requirement with explicit invariants, negative tests, deterministic replay, resource bounds, and evidence artifacts.
...
### Q7 — Evidence package
Generate:
- `BR-450-11_requirements.json` — status and evidence hash for every atomic requirement.
- `BR-450-11_tests.log` — exact commands, exit codes, and salient output.
- `BR-450-11_audit.md` — human-readable before/after findings and unresolved blockers.
- `BR-450-11_manifest.sha256` — hashes of every file changed or generated by this work package.
...
|---|---|---|---|
| BR-450-11-R01 | Every injected interruption recovers predictably | NOT RUN | — |
| BR-450-11-R02 | No partially installed image becomes active | NOT RUN | — |
| BR-450-11-R03 | Latest authenticated committed state wins | NOT RUN | — |
| BR-450-11-R04 | Previous valid image remains recoverable | NOT RUN | — |

## Required output
Return a modified repository or patch set, the complete evidence package, exact reproduction commands, a concise change log, unresolved blockers, and the final gate decision for **BR-450-11**. The next package may consume this package only when its declared prerequisite status is satisfied.
