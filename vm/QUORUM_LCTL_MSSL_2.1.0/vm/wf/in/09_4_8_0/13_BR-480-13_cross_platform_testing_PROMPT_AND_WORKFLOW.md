# QUORUM BR-480-13 — Cross-platform testing
...
Using QUORUM, upgrade the attached BOTTLE ROCKET 4.0.0 COLUMNED LCTL repository to satisfy **Cross-platform testing** as an evidence-backed step toward BOTTLE ROCKET 5.0.0 FULLY OPERATIONAL VM. Work directly against the repository; do not replace executable behavior with prose, mocks, placeholder PASS files, or unverifiable claims. Preserve working behavior unless this package explicitly supersedes it.
...
### Atomic requirements
- **BR-480-13-R01:** Test GCC
- **BR-480-13-R02:** Test Clang
- **BR-480-13-R03:** Test x86-64
- **BR-480-13-R04:** Test AArch64
- **BR-480-13-R05:** Test Linux
- **BR-480-13-R06:** Test Windows adapter if supported
- **BR-480-13-R07:** Test different optimization levels
...
Define the invariants for **Cross-platform testing** before editing code. At minimum specify: accepted inputs, rejected inputs, state transitions, trust boundary, resource ceiling, deterministic/replay behavior, compatibility/version behavior, and the exact condition that produces OPERATIONAL status.

### Q2 — Implementation
1. **BR-480-13-R01 — Test GCC.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
2. **BR-480-13-R02 — Test Clang.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
3. **BR-480-13-R03 — Test x86-64.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
4. **BR-480-13-R04 — Test AArch64.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
5. **BR-480-13-R05 — Test Linux.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
6. **BR-480-13-R06 — Test Windows adapter if supported.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
7. **BR-480-13-R07 — Test different optimization levels.** Add deterministic positive and negative tests, adversarial cases, bounded resource assertions, and machine-readable pass/fail evidence.
...
### Q7 — Evidence package
Generate:
- `BR-480-13_requirements.json` — status and evidence hash for every atomic requirement.
- `BR-480-13_tests.log` — exact commands, exit codes, and salient output.
- `BR-480-13_audit.md` — human-readable before/after findings and unresolved blockers.
- `BR-480-13_manifest.sha256` — hashes of every file changed or generated by this work package.
...
|---|---|---|---|
| BR-480-13-R01 | Test GCC | NOT RUN | — |
| BR-480-13-R02 | Test Clang | NOT RUN | — |
| BR-480-13-R03 | Test x86-64 | NOT RUN | — |
| BR-480-13-R04 | Test AArch64 | NOT RUN | — |
| BR-480-13-R05 | Test Linux | NOT RUN | — |
| BR-480-13-R06 | Test Windows adapter if supported | NOT RUN | — |
| BR-480-13-R07 | Test different optimization levels | NOT RUN | — |

## Required output
Return a modified repository or patch set, the complete evidence package, exact reproduction commands, a concise change log, unresolved blockers, and the final gate decision for **BR-480-13**. The next package may consume this package only when its declared prerequisite status is satisfied.
