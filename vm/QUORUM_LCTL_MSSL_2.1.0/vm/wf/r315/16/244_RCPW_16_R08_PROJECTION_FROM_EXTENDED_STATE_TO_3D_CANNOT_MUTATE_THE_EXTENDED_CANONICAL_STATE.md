...
10. **Evidence receipt.** Emit `vm/world/evidence/remediation_315/RCPW-16-R08.json` conforming to `00`, including exact commands, exit codes, observed values, digests, profile, hashes, and blocker field.
