...
Simulate ecosystems continuously across folded space using fidelity appropriate to distance and causal importance.
...
- **RCPW-07-R01:** Local individual and remote cohort/statistical ecology share one authoritative ecological state model.
...
- **RCPW-07-R04:** Weather, season, terrain, food, predation, disease, hunting, and human settlement can influence ecology through explicit couplings.
- **RCPW-07-R05:** Random ecological resolutions are deterministic under recorded seeds.
- **RCPW-07-R06:** Long-run population behavior is bounded and audited for artificial explosions/extinctions caused by LOD transitions.
...
- **RCPW-07-R09:** Spatial folding cannot collapse independent habitats into one ecological interaction domain.
- **RCPW-07-R10:** Rehydrated local ecology is statistically and causally consistent with its aggregate history.
...
- **RCPW-07-R12:** Ecology couples to qualified weather, fire, water, season, day/night, vegetation, and human pressure state.
- **RCPW-07-R13:** Local depletion and remote regeneration use one conserved resource model with declared approximation bounds.
- **RCPW-07-R14:** Rehydrated individual animals/plants inherit age, health, location, group, and causal history consistent with remote cohort evolution.

- **RCPW-07-R15:** Ecology authority exposes habitat capacity, migration routes, resource flows, predation pressure, and human interference as canonical graph/state inputs rather than display-space approximations.
- **RCPW-07-R16:** Ecological cohorts support deterministic split/merge operations when regions fold, unfold, divide, or materialize.
- **RCPW-07-R17:** Remote ecology can suspend at event barriers requiring direct interaction rather than fabricating high-detail outcomes.
- **RCPW-07-R18:** Ecological materialization selects individuals from cohort state without changing conserved population/resource totals beyond declared stochastic tolerance.
...
- **RCPW-07-R23:** Environment/ecology coupling across partitions uses explicit boundary state and canonical simulation time.
- **RCPW-07-R24:** Ecology scale qualification compares partitioned and reference single-partition runs within declared stochastic/conservation tolerances.
...
- **RCPW-07-R26:** Species/cohort migration into newly synthesized regions uses canonical habitat/topology constraints and deterministic provenance.
...
- **RCPW-07-R28:** Archived ecological regions retain sufficient conserved state to rehydrate populations and causal environmental evidence after long absence.
...
1. Define species, cohorts, habitats, territories, food/energy resources, breeding, mortality, predation, migration, disease, and scavenging variables.
2. Define individual↔cohort conversion and conservation tolerances.
3. Implement remote encounter resolution using deterministic seeded probability or analytic transitions.
4. Map remote outcomes into causal evidence such as carcasses, tracks, missing individuals, population movement, depleted forage, and scavenger attraction.
5. Couple ecological state to weather, season, terrain, settlement expansion, hunting pressure, fire, and resource depletion.
6. Integrate ecological priority with reference shells and narrative gravity.
7. Run multi-season simulations, fold/unfold campaigns, and extreme pressure scenarios.
8. Compare aggregate and fully resolved small-world reference simulations to quantify acceptable approximation error.
...
- `ECOLOGY_AUTHORITY.mssl`
- `ecology_authority.lctlc`
- `ECOLOGY_MODEL.md`
- `SPECIES_SCHEMA.json`
- `ECOLOGY_ERROR_BUDGET.json`
- `ECOLOGY_QUALIFICATION.json`
- `RCPW-07_requirements.json`
- `RCPW-07_tests.log`
- `RCPW-07_audit.md`
- `RCPW-07_manifest.sha256`
...
|---|---|---|---|
| RCPW-07-R01 | Local individual and remote cohort/statistical ecology share one authoritative ecological state model. | NOT_STARTED | — |
| RCPW-07-R02 | Promotion/demotion between individuals and cohorts is mass/population consistent within declared tolerances. | NOT_STARTED | — |
| RCPW-07-R03 | Remote ecological interactions create durable consequences that can later materialize locally. | NOT_STARTED | — |
| RCPW-07-R04 | Weather, season, terrain, food, predation, disease, hunting, and human settlement can influence ecology through explicit couplings. | NOT_STARTED | — |
| RCPW-07-R05 | Random ecological resolutions are deterministic under recorded seeds. | NOT_STARTED | — |
| RCPW-07-R06 | Long-run population behavior is bounded and audited for artificial explosions/extinctions caused by LOD transitions. | NOT_STARTED | — |
| RCPW-07-R07 | Ecological time-step adaptation is bounded and conservation error is measured per species/resource system. | NOT_STARTED | — |
| RCPW-07-R08 | Remote stochastic outcomes expose reproducible seeds and probability models. | NOT_STARTED | — |
| RCPW-07-R09 | Spatial folding cannot collapse independent habitats into one ecological interaction domain. | NOT_STARTED | — |
| RCPW-07-R10 | Rehydrated local ecology is statistically and causally consistent with its aggregate history. | NOT_STARTED | — |

| RCPW-07-R11 | Habitat connectivity is canonical and cannot be altered merely by visual fold distance; migration uses canonical route/topology cost. | NOT_STARTED | — |
| RCPW-07-R12 | Ecology couples to qualified weather, fire, water, season, day/night, vegetation, and human pressure state. | NOT_STARTED | — |
| RCPW-07-R13 | Local depletion and remote regeneration use one conserved resource model with declared approximation bounds. | NOT_STARTED | — |
| RCPW-07-R14 | Rehydrated individual animals/plants inherit age, health, location, group, and causal history consistent with remote cohort evolution. | NOT_STARTED | — |

| RCPW-07-R15 | Ecology authority exposes habitat capacity, migration routes, resource flows, predation pressure, and human interference as canonical graph/state inputs rather than display-space approximations. | NOT_STARTED | — |
| RCPW-07-R16 | Ecological cohorts support deterministic split/merge operations when regions fold, unfold, divide, or materialize. | NOT_STARTED | — |
| RCPW-07-R17 | Remote ecology can suspend at event barriers requiring direct interaction rather than fabricating high-detail outcomes. | NOT_STARTED | — |
| RCPW-07-R18 | Ecological materialization selects individuals from cohort state without changing conserved population/resource totals beyond declared stochastic tolerance. | NOT_STARTED | — |
| RCPW-07-R19 | Ecology qualification includes long-soak biodiversity, resource depletion/recovery, seasonal migration, and repeated individual↔cohort cycling. | NOT_STARTED | — |

| RCPW-07-R20 | Ecological regions may execute on different workers/partitions while migration and shared-resource boundaries use canonical transfer events. | NOT_STARTED | — |
| RCPW-07-R21 | Cohort split/merge across partition boundaries is deterministic and conservation-audited. | NOT_STARTED | — |
| RCPW-07-R22 | Ecological worker restart resumes from checkpoint plus ledger without population duplication or lost resource debt. | NOT_STARTED | — |
| RCPW-07-R23 | Environment/ecology coupling across partitions uses explicit boundary state and canonical simulation time. | NOT_STARTED | — |
| RCPW-07-R24 | Ecology scale qualification compares partitioned and reference single-partition runs within declared stochastic/conservation tolerances. | NOT_STARTED | — |

| RCPW-07-R25 | Ecology supports long-term succession, habitat transformation, local extinction/reintroduction, resource regeneration, and climate/season coupling across world ages. | NOT_STARTED | — |
| RCPW-07-R26 | Species/cohort migration into newly synthesized regions uses canonical habitat/topology constraints and deterministic provenance. | NOT_STARTED | — |
| RCPW-07-R27 | Ecological inheritance tracks persistent habitat changes caused by settlement growth, infrastructure, fire, resource depletion, and restoration. | NOT_STARTED | — |
| RCPW-07-R28 | Archived ecological regions retain sufficient conserved state to rehydrate populations and causal environmental evidence after long absence. | NOT_STARTED | — |
| RCPW-07-R29 | Qualification includes multi-era ecological succession, settlement expansion pressure, climate variation, region synthesis, archive, and later rehydration. | NOT_STARTED | — |
