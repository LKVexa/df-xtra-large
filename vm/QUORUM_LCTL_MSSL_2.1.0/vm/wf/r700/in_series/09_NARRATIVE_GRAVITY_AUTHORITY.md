...
Retain greater simulation authority for important remote entities/events than for irrelevant background activity when appropriate.
...
- **RCPW-09-R01:** Narrative gravity is independent from raw distance and has explicit inputs.
...
- **RCPW-09-R03:** Active missions, companions, rivals, threats, and major remote events can create authority wells.
...
- **RCPW-09-R09:** Gravity changes emit traceable reasons to support replay and debugging.
...
- **RCPW-09-R19:** Narrative qualification includes competing events, player avoidance, rapid traversal, save/reload, reference handoff, and long off-screen intervals.
...
- **RCPW-09-R26:** Emergent event synthesis must consume canonical conditions and knowledge-locality rules rather than inventing facts required only to satisfy a desired story beat.
- **RCPW-09-R27:** NPC dialogue/event eligibility may depend on what the NPC or institution plausibly knows, not merely on global ledger truth.
- **RCPW-09-R28:** Historical events may seed future narrative opportunities through explicit causal hooks that survive save migration and world archival.
- **RCPW-09-R29:** Qualification includes multi-era narrative consequences, rumor/information delay, role succession, emergent event generation, and archival history reactivation.

## Stage-Specific Engineering Workflow

1. Define gravity inputs including mission relevance, player relationship, causal significance, threat, recency, visibility forecast, authored importance, and unresolved obligations.
2. Normalize gravity values and define caps, decay, escalation, and hysteresis.
3. Integrate gravity into LOD and materialization scheduling without replacing canonical authority.
4. Create remote authority wells for high-value missions, companions, battles, timed events, and narrative observers.
5. Define resource arbitration when multiple high-gravity events compete.
6. Create abuse/stress tests for deliberately maximizing narrative significance.
7. Replay narrative-gravity traces to prove deterministic prioritization.
8. Verify that major remote events re-materialize with continuous causal history rather than scripted reset.
...
- `NARRATIVE_GRAVITY.mssl`
- `narrative_gravity.lctlc`
- `GRAVITY_MODEL.md`
- `GRAVITY_POLICY.json`
- `AUTHORITY_WELL_TESTS.json`
- `NARRATIVE_CONTINUITY_EVIDENCE.json`
- `RCPW-09_requirements.json`
- `RCPW-09_tests.log`
- `RCPW-09_audit.md`
- `RCPW-09_manifest.sha256`
...
|---|---|---|---|
| RCPW-09-R01 | Narrative gravity is independent from raw distance and has explicit inputs. | NOT_STARTED | — |
| RCPW-09-R02 | Narrative significance changes priority, update frequency, and representation only within bounded resource policy. | NOT_STARTED | — |
| RCPW-09-R03 | Active missions, companions, rivals, threats, and major remote events can create authority wells. | NOT_STARTED | — |
| RCPW-09-R04 | Narrative gravity decays or transitions according to explicit lifecycle rules. | NOT_STARTED | — |
| RCPW-09-R05 | Narrative gravity cannot mutate canonical story truth by itself. | NOT_STARTED | — |
| RCPW-09-R06 | Priority manipulation and starvation attacks are bounded and testable. | NOT_STARTED | — |
| RCPW-09-R07 | Narrative gravity is signed/typed so urgency, relevance, threat, and authored importance are distinguishable. | NOT_STARTED | — |
| RCPW-09-R08 | Priority escalation has hard caps and reserve budgets for non-narrative systemic simulation. | NOT_STARTED | — |
| RCPW-09-R09 | Gravity changes emit traceable reasons to support replay and debugging. | NOT_STARTED | — |
| RCPW-09-R10 | No narrative-gravity rule may fabricate outcomes for events that require canonical simulation evidence. | NOT_STARTED | — |

| RCPW-09-R11 | Narrative gravity integrates with an event-orchestration authority that distinguishes authored beats, systemic events, optional encounters, and emergent consequences. | NOT_STARTED | — |
| RCPW-09-R12 | Off-screen event resolution declares whether the outcome was fully simulated, abstractly resolved, deferred, or blocked awaiting higher fidelity. | NOT_STARTED | — |
| RCPW-09-R13 | Narrative priority cannot violate canonical travel time, ownership, death, destruction, or other established causal facts without an explicit authored override event. | NOT_STARTED | — |
| RCPW-09-R14 | Competing narrative wells use deterministic arbitration and expose why one event received higher simulation authority. | NOT_STARTED | — |

| RCPW-09-R15 | Narrative gravity consumes explicit story/event metadata but does not own canonical facts such as death, travel, inventory, location, or destruction. | NOT_STARTED | — |
| RCPW-09-R16 | Narrative authority supports event reservation so two authored/systemic events cannot simultaneously claim an exclusive actor/resource without arbitration. | NOT_STARTED | — |
| RCPW-09-R17 | Story/event conditions are evaluated against canonical state and ledger history rather than render presence. | NOT_STARTED | — |
| RCPW-09-R18 | Deferred narrative events carry expiration, escalation, and fallback semantics so off-screen blocking cannot deadlock the world. | NOT_STARTED | — |
| RCPW-09-R19 | Narrative qualification includes competing events, player avoidance, rapid traversal, save/reload, reference handoff, and long off-screen intervals. | NOT_STARTED | — |

| RCPW-09-R20 | Narrative reservations and authority wells are globally arbitrated even when actors/events are simulated on different workers. | NOT_STARTED | — |
| RCPW-09-R21 | Exclusive actor/resource reservations use deterministic conflict resolution and survive partition migration/recovery. | NOT_STARTED | — |
| RCPW-09-R22 | Narrative state read from a lagging partition is revision-checked before committing canonical story consequences. | NOT_STARTED | — |
| RCPW-09-R23 | Authored live-content updates cannot rewrite completed canonical history unless delivered as explicit versioned migration/retcon events. | NOT_STARTED | — |
| RCPW-09-R24 | Narrative qualification includes hot content patch, worker restart, competing reservations, long off-screen deferral, and rollback. | NOT_STARTED | — |

| RCPW-09-R25 | Narrative gravity distinguishes world-history significance from immediate player-story relevance so historically important remote changes may remain durable without consuming high local fidelity indefinitely. | NOT_STARTED | — |
| RCPW-09-R26 | Emergent event synthesis must consume canonical conditions and knowledge-locality rules rather than inventing facts required only to satisfy a desired story beat. | NOT_STARTED | — |
| RCPW-09-R27 | NPC dialogue/event eligibility may depend on what the NPC or institution plausibly knows, not merely on global ledger truth. | NOT_STARTED | — |
| RCPW-09-R28 | Historical events may seed future narrative opportunities through explicit causal hooks that survive save migration and world archival. | NOT_STARTED | — |
| RCPW-09-R29 | Qualification includes multi-era narrative consequences, rumor/information delay, role succession, emergent event generation, and archival history reactivation. | NOT_STARTED | — |
